...
The stack_unwinding is a small header only C++ library which supplies primitive(class unwinding_indicator) to determining when class destructor is called due to stack-unwinding or due to normal scope leaving.
